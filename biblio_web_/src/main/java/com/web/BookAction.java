...
import com.firstprojet.business.service.BookService;
...
public class BookAction extends BaseAction {
	...
	@Action(value="showFormUpdate", results = { @Result( location ="formModifyBook.jsp", name ="updateform"),
	 ...
	 * @return
	 */
	@Action(value="addBook", results = { @Result(  name = "success",location ="form.jsp") })
	 ...
	 * @return
	 */
	@Action(value="updateBook", results = { @Result(  name = "success",location ="formModifyBook.jsp") })
	 ...
	 */
	@Action(value="searchBook", results = { @Result(  name = "success",location ="ist.jsp") })
	...
	@Action(value="showSearchForm", results = { @Result(  name = "success",location ="showSearchForm.jsp") })
