 ...
 * les DAOs
 * 
 * @author <a href="mailto:tarik.boudaa@gmail.com">T.BOUDAA Ecole Nationale des Sciences Appliquées </a>
 * 
 * @param <T>
...
public interface GenericDao<T, PK> {
	...
	/**
	 * Méthode générique pour mettre é jour un objet modifié en dehors de la
	 * session
	 * 
	 * @param pObject
